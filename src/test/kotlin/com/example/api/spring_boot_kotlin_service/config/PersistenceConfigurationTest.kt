...
class PersistenceConfigurationTest {
    private lateinit var persistenceConfiguration: com.example.api.spring_boot_kotlin_service.config.PersistenceConfiguration
    ...
    internal inner class DataSourceProperties {
        ...
        fun dataSourcePropertiesTest() {
            Assertions.assertNotNull(persistenceConfiguration.sampleDataSourceProperties())
        }
    }
    ...
    internal inner class DataSource {
        ...
        fun dataSourceTest() {
            ...
            Assertions.assertNotNull(persistenceConfiguration.sampleDataSource(dataSourceProperties))
        }
    ...
    internal inner class SampleEntityEntityManagerFactory {
        ...
        fun sampleEntityManagerFactoryTest() {
            ...
            dataSourceProperties.password = PASSWORD
            dataSourceProperties.driverClassName = DRIVER_CLASS
            val dataSource = persistenceConfiguration.sampleDataSource(dataSourceProperties)
            Assertions.assertNotNull(persistenceConfiguration.sampleEntityManagerFactory(dataSource, factory))
        }
    }
